import { addCoordinateTransforms, Projection, addProjection } from 'ol/proj'
...
addProjection(gcjProjection)
addCoordinateTransforms('EPSG:4326', gcjProjection, projzh.ll2gmerc, projzh.gmerc2ll)
